...
export const dummyTestimonial = [
    {
        ...
        rating: 5,
        feedback: '"TutorSync has completely changed the way I study! The personalized recommendations and expert tutors make learning so much easier and more effective."',
    },
    {
        name: 'Ramya S U',
        role: 'SWE 2 @ Samsung',
        ...
        rating: 4,
        feedback: '"Finding the right study materials used to be a struggle, but TutorSync makes it effortless. Now, I can learn at my own pace with the best resources."',
    },
    {
        name: 'Ziyan S',
        role: 'SWE 2 @ Google',
        ...
        rating: 4.5,
        feedback: '"I love how TutorSync connects me with the perfect tutors for my needs. It’s simple, effective, and has made a huge difference in my learning journey!"',
    },
];
