...
const CourseDetails = () => {
  ...
  const { currency, allCourses, calculateRating,
      calculateNoOfLectures, calculateCourseDuration,calculateChapterTime} = useContext(AppContext);
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left"
      >
        <div className="absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-orange-200 to-pink-300"></div>

        {/*left-column*/}
        <div className="max-w-xl z-10 text-gray-500">
          <h1
            className="md:text-course-deatails-heading-large text-course-deatails-heading-small
        font-semibold text-gray-800"
          ...
          ></p>
            ...
            <p className="text-sm">Course by <span className="text-blue-600 underline "> TutorSync </span></p>
                  ...
                  <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                    ...
                    cursor-pointer select-none" onClick={()=> toggleSection(index)}>
                      <div className="flex items-center gap-2">
                        <img className={`transform transition-transition ${openSections[index]?'rotate-180':''}`}
